      ...
      <section className="w-full bg-gray-50 py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {/* Service Card 8: Planter Waterproofing */}
            <a href='/services/balcony-waterproofing-coating-repair' className="bg-white rounded-lg shadow-lg overflow-hidden">
              <img 
                src="/s6.webp" 
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-800 mb-3">Balcony Waterproofing</h3>
                <p className="text-gray-600 mb-4">
                Your balcony is a valuable extension of your living space, but water leaks can cause serious structural damage if left unprotected.
                </p>
              </div>
            </a>
            ...
            {/* Service Card 6: Planter Waterproofing */}
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <img 
                src="/s6.webp" 
                alt="Worker applying coating to concrete planter box" 
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-800 mb-3">Roof Deck Waterproofing</h3>
                <p className="text-gray-600 mb-4">
                A roof deck expands your living space and offers beautiful views, but without proper waterproofing, it can quickly deteriorate.
                </p>
              </div>
            </div>


            {/* Service Card 7: Planter Waterproofing */}
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <img 
                src="/s6.webp" 
                alt="Worker applying coating to concrete planter box" 
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-800 mb-3">Stair Waterproofing</h3>
                <p className="text-gray-600 mb-4">
                Exterior stairs are constantly exposed to rain, sun, and heavy use, making them vulnerable to cracks, leaks, and unsafe surfaces.
                </p>
              </div>
            </div>
