  ...
  return (
    ...
    <div className="relative w-full h-[500px] lg:h-[750px]">
      ...
      <div 
        ...
        style={{
          backgroundImage: "url('/Area/Los Angeles Deck Waterproofing/banner.jpg')"
        }}
      >
        {/* Dark Overlay */}
          ...
          <div className="lg:col-span-1">
            <div className=" top-8">
              <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                <img 
                  src="/Area/Los Angeles Deck Waterproofing/1.jpg" 
      ...
      <div className="container mx-auto max-w-8xl">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <img 
                src="/Area/Los Angeles Deck Waterproofing/2.jpg" 
      ...
      <div className="container mx-auto max-w-8xl">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <img 
                src="/Area/Los Angeles Deck Waterproofing/3.jpg" 
