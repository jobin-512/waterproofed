...
export const Route = createFileRoute('/_layout/blogs/What-is-Epoxy-Flooring')({
  head: () => ({
    meta: [
      {
        name: 'description',
    ...
    <>
      <div className="mx-auto max-w-6xl px-4 py-10">
        ...
        <article className="prose max-w-none">
          ...
          <h2 className="mt-10 text-3xl md:text-4xl font-bold">How Long Can Epoxy Floors be Expected to Last?</h2>
          <p>
          ...
          <figure className="my-8">
            <img
              src="/blogs/b20.webp"
              alt="Professional epoxy flooring installation in progress"
              className="w-full rounded object-cover"
            />
            <figcaption className="text-center text-sm text-gray-600 mt-2">
              High-quality epoxy flooring installation
            </figcaption>
          </figure>

          <h2 className="mt-10 text-3xl md:text-4xl font-bold">Variations of Epoxy Flooring</h2>
          <p>You have access to a wide variety of epoxy floor options, including:</p>

          <h3 className="mt-6 text-xl font-semibold">1. Self-Levelling</h3>
          <p>
          ...
          <h3 className="mt-6 text-xl font-semibold">2. Self-Dispersing</h3>
          <p>
          ...
          <h3 className="mt-6 text-xl font-semibold">3. Mortar</h3>
          <p>
          ...
          <h3 className="mt-6 text-xl font-semibold">4. Graveled</h3>
          <p>
          ...
          <h3 className="mt-6 text-xl font-semibold">5. Terrazzo</h3>
          <p>
          ...
          <h3 className="mt-6 text-xl font-semibold">6. Anti-Static</h3>
          <p>
          ...
          <h3 className="mt-6 text-xl font-semibold">7. Flaked</h3>
          <p>
          ...
          <h2 className="mt-10 text-3xl md:text-4xl font-bold">Applications of Epoxy Flooring</h2>
          <p>
          ...
          <h3 className="mt-6 text-xl font-semibold">Commercial Applications</h3>
          <p>
          ...
          <h4 className="mt-4 text-lg font-semibold">Epoxy Floor Coating for Undercover Parking Garages</h4>
          <p>
          ...
          <h4 className="mt-4 text-lg font-semibold">Epoxy Floor Coating for Industrial and Warehouse Buildings</h4>
          <p>
          ...
          <h4 className="mt-4 text-lg font-semibold">Epoxy Floor Coating for Offices</h4>
          <p>
          ...
          <h4 className="mt-4 text-lg font-semibold">Epoxy Floor Coating for Gymnasiums</h4>
          <p>
          ...
          <h3 className="mt-6 text-xl font-semibold">Residential Applications</h3>
          <p>
          ...
          <h4 className="mt-4 text-lg font-semibold">Epoxy Floor Coating for the Kitchen</h4>
          <p>
          ...
          <h4 className="mt-4 text-lg font-semibold">Epoxy Floor Coating for Home Garages</h4>
          <p>
          ...
          <h2 className="mt-10 text-3xl md:text-4xl font-bold">Benefits of Epoxy Flooring</h2>
          <p>
            There are various advantages to opting for epoxy flooring for your property or business, including the following:
          </p>

          <h3 className="mt-6 text-xl font-semibold">1. The Surface is Seamless and Easily Cleanable</h3>
          <p>
          ...
          <h3 className="mt-6 text-xl font-semibold">2. Resistant to Water and Stains</h3>
          <p>
          ...
          <h3 className="mt-6 text-xl font-semibold">3. Durability</h3>
          <p>
          ...
          <h3 className="mt-6 text-xl font-semibold">4. Appearance</h3>
          <p>
          ...
          <h3 className="mt-6 text-xl font-semibold">5. Cost Efficiency</h3>
          <p>
          ...
          <h3 className="mt-6 text-xl font-semibold">6. Resilience</h3>
          <p>
          ...
          <h3 className="mt-6 text-xl font-semibold">7. Safety</h3>
          <p>
          ...
          <h3 className="mt-6 text-xl font-semibold">8. Eco-Friendly</h3>
          <p>
          ...
          <h3 className="mt-6 text-xl font-semibold">9. Simple to Maintain</h3>
          <p>
          ...
          <h2 className="mt-10 text-3xl md:text-4xl font-bold">Key Considerations</h2>
          <ul className="list-disc pl-6 mt-4 space-y-2">
            <li><span className="font-semibold">Professional Installation:</span> Epoxy flooring requires proper surface preparation and professional application for best results.</li>
            <li><span className="font-semibold">Surface Preparation:</span> The existing floor must be properly cleaned, repaired, and prepared before epoxy application.</li>
            <li><span className="font-semibold">Curing Time:</span> Epoxy floors need adequate time to cure before they can be walked on or used.</li>
            <li><span className="font-semibold">Maintenance:</span> Regular cleaning and occasional re-coating may be necessary to maintain appearance and performance.</li>
            <li><span className="font-semibold">Temperature Sensitivity:</span> Epoxy application and curing are temperature-dependent processes.</li>
          </ul>
          ...
          <p className="mt-4">
            Epoxy flooring represents a smart investment for both residential and commercial properties, offering unmatched durability, aesthetic appeal, and low maintenance requirements. Whether you're looking to upgrade your garage, commercial space, or industrial facility, epoxy flooring provides a long-term solution that combines functionality with visual appeal.
          </p>
        </article>
      </div>
      <Testimonial />
