...
export const Route = createFileRoute('/_layout/services/Professional-Concrete-Floor-Leveling',)({
  head: () => ({
    meta: [
      {
        name: 'description',
  ...
  return (
    ...
    <div className="relative w-full h-[500px] lg:h-[750px]">
      ...
      <div 
        ...
        style={{
          backgroundImage: "url('/Services/Concrete Floor Leveling/1.jpg')"
        }}
      >
        {/* Dark Overlay */}
    ...
    <div className="py-16 px-4">
      <div className="container mx-auto max-w-8xl">
        ...
        <p className="text-lg text-gray-700 leading-relaxed mb-8 text-center">
          Sloping floors in homes and buildings are not simply a nuisance—they can indicate structural issues. We offer floor leveling services that address root causes, not just symptoms. Our Santa Monica–based team levels and repairs concrete and wood floors, garage slabs, and basement foundations with excellent results.
        </p>
        
        {/* Service Description Paragraph */}
        <p className="text-lg text-gray-700 leading-relaxed mb-12 text-center">
          Through years of experience and state-of-the-art equipment, Water Proofed has earned the distinction of being a top provider for professional concrete floor leveling in Santa Monica. Our method corrects uneven floors now and helps prevent future issues—supporting remodeling, new flooring, and everyday comfort.
        </p>
        ...
        <div className="bg-[#1a4a5e] rounded-lg p-8 md:p-12 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">
              Built to protect your home, investment, and comfort—start with a free consult.
            </h2>
    ...
    {/* Why Floor Leveling Matters Section */}
      ...
      <div className="container mx-auto max-w-8xl">
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mb-8">
              <p className="text-gray-700 mb-3">
                Uneven floors can quickly escalate into major structural concerns. Proper leveling is not just cosmetic—it protects your foundation, your investment, and peace of mind. Read below to learn how our concrete and wood floor leveling process restores safety and stability.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-1">
            <div className=" top-8">
              <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                <img 
                  src="/Services/Concrete Floor Leveling/2.jpg" 
    ...
    {/* Our Proven Floor Leveling Process Section */}
    <div className="py-16 px-4">
      <div className="container mx-auto max-w-8xl">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <img 
                src="/Services/Concrete Floor Leveling/3.jpg" 
          ...
          <div className="order-1 lg:order-2">
            {/* Main Heading */}
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Our Proven Floor Leveling Process
            </h2>
            
            {/* Introduction */}
            <p className="text-lg text-gray-700 leading-relaxed mb-8">
              We do not take shortcuts. Every floor leveling project follows a strict, proven process that ensures long-term protection and performance.
            </p>
            
            {/* Thorough Inspection & Surface Preparation */}
            <div className="mb-8">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">On-Site Assessment and Diagnosis</h3>
              <p className="text-gray-700">
                The first and essential step to success. We visit your property to measure slopes, identify structural issues, and check for moisture intrusion. Understanding how and why the floor behaves a certain way informs our plan.
              </p>
            </div>
            
            {/* Professional Coating & Membrane Application */}
            <div className="mb-8">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Customized Planning and Recommendations</h3>
              <p className="text-gray-700 mb-4">
                No two floors are the same. Based on our findings, we may grind high spots, fill low areas, add structural support, or use self-leveling compounds—coordinated with your final floor (tile, wood, carpet, epoxy) for the best outcome.
              </p>
            </div>
            
            {/* Flashing Installation */}
            <div className="mb-8">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Execution with Precision Tools</h3>
              <p className="text-gray-700 mb-4">
                With your approval, we use laser-guided levels, concrete grinders, self-leveling mixes, and structural reinforcement to bring floors into true. Our clean, efficient crews minimize disruption in tight hallways or large garages alike.
              </p>
            </div>
            
            {/* Root Barrier Installation */}
            <div className="mb-8">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Final Review and Quality Assurance</h3>
              <p className="text-gray-700 mb-4">
                After leveling, we verify slopes and tolerances, tidy the work area, and provide care guidance for your flooring install. Our goal is long-term stability that feels invisible day to day—and dependable for years.
              </p>
            </div>
    ...
    <div className="py-16 px-4">
      <div className="container mx-auto max-w-8xl">
        ...
        <div className="mb-8">
          <h3 className="text-xl font-semibold text-gray-900 mb-4">Professional Concrete Floor Leveling Services in Santa Monica, CA</h3>
          <p className="text-gray-700 mb-4">
            Concrete is durable but not indestructible. Soil movement, moisture, temperature changes, and structural shifts can cause sagging, cracking, or sloping. Our leveling services use high-quality equipment and self-leveling compounds to within a millimeter—preparing basements, living areas, garages, and commercial spaces for safe foot traffic, flooring installs, and machinery.
          </p>
        </div>
        
        {/* Expert Wood Floor Leveling */}
        <div className="mb-8">
          <h3 className="text-xl font-semibold text-gray-900 mb-4">Expert Wood Floor Leveling Services in Santa Monica, CA</h3>
          <p className="text-gray-700 mb-4">
            Wood floors require special care. Sagging, cupping, and warping are often caused by moisture or weakened substrates—especially in older Santa Monica homes. We assess subfloors and joists, rebuild where needed, and deliver a level, durable base for hardwood, engineered wood, or laminate.
          </p>
          <p className="text-gray-700">
            The result: improved appearance and performance—especially in areas with shifting soils or humidity.
          </p>
        </div>
      </div>
    </div>
      ...
      <div className="container mx-auto max-w-8xl">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <img 
                src="/Services/Concrete Floor Leveling/4.jpg" 
