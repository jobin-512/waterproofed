...
export const Route = createFileRoute('/_layout/services/balcony-waterproofing-coating-repair',)({
  head: () => ({
    meta: [
      {
        name: 'description',
  ...
  return (
    ...
    <div className="relative w-full h-[500px] lg:h-[750px]">
      ...
      <div 
        ...
        style={{
          backgroundImage: "url('/Services/Balcony Waterproofing Coating Repair/1.jpg')"
        }}
      >
        {/* Dark Overlay */}
      ...
      <div className="relative z-10 flex items-center justify-center h-full">
        <div className="text-center text-white px-4">
          ...
          Looking for a Waterproofing Contractor? Southern California Decking's Professional Team Is Your One Stop Solution for Balcony Waterproofing and Coating Needs.
          </p>
        </div>
      </div>
    </div>
          ...
          <div className="lg:col-span-1">
            <div className=" top-8">
              <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                <img 
                  src="/Services/Balcony Waterproofing Coating Repair/3.jpg" 
      ...
      <div className="container mx-auto max-w-8xl">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <img 
                src="/Services/Balcony Waterproofing Coating Repair/4.jpg" 
      ...
      <div className="container mx-auto max-w-8xl">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <img 
                src="/Services/Balcony Waterproofing Coating Repair/5.jpg" 
